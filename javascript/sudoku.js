        ...
        */
        ...
        var renderBoardCell = function(originalBoardCell, boardCell, id) {
            ...
            return "<div class='sudoku-board-cell'>" +
                        ...
                        "<input type='number' min='1' max='9' pattern='\\d*' "+((disabled)?'disabled ':'')+"novalidate id='input-"+id+"' value='"+val+"'"+maxlength+">" +
        ...
        var resetBoard = function() {
            ...
            for(let i=0; i <boardSize*boardSize;i++) {
                board[i] = {
                    ...
                    candidates: originalBoard[i].candidates,
        ...
        var solveFn = function(i) {
            ...
            if (boardFinished) {
                ...
                if (effectedCells && effectedCells !== -1) {
                    ...
                    for(let j=0; j < effectedCells.length; j++) {
